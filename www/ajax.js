    ...
    $.ajax({
        ...
        success: function (response) {
            if (response.done == true) {
                ...
                $('#getBookingID').html(response.booking_id);
                $('#checkIn').modal('show');
            } else {
                alert(response.data);
            }
...
$('#addUser').submit(function () {
    ...
    var full_name = $('#first_name').val().concat(" ", $('#last_name').val());
    ...
    $.ajax({
        ...
        success: function (response) {
            if (response.done == true) {
                ...
                $('.emp-response').html('<div class="alert bg-success alert-dismissable" role="alert"><em class="fa fa-lg fa-warning">&nbsp;</em>Registration Successful</div>');
            } else {
                $('.emp-response').html('<div class="alert bg-danger alert-dismissable" role="alert"><em class="fa fa-lg fa-warning">&nbsp;</em>' + response.data + '</div>');
            }
        }
